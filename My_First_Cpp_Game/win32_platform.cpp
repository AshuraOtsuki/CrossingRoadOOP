...
int WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd) {
	...
	HWND window = CreateWindow(window_class.lpszClassName, "MY FIRST GAME!!", WS_OVERLAPPEDWINDOW | WS_VISIBLE, CW_USEDEFAULT, CW_USEDEFAULT, 1350, 940, 0, 0, hInstance, 0);
	HDC hdc = GetDC(window); //need a context window use to draw to it, hdc will take this task
	disableMaximize(window);
	setAndCenterWindow(window, 1500, 940);

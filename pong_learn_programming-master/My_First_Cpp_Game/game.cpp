...
simulate_game(Input* input, float dt) {
	draw_rect(0, 0, arena_half_size_x, arena_half_size_y, 0xffaa33,0);
	...
	//	// Rendering
	//	draw_rect(ball_p_x, ball_p_y, ball_half_size, ball_half_size, 0xffffff,0);

	//	draw_rect(80, player_1_p, player_half_size_x, player_half_size_y, 0xff0000,0);
	//	draw_rect(-80, player_2_p, player_half_size_x, player_half_size_y, 0xff0000,0);
